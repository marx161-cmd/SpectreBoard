// Ported from Outspoke (github.com/minburg/outspoke, GPLv3) ime/correction/SuggestionFileManager.kt.
// Downloader (SuggestionFileDownloader) not ported - dict/LM files staged externally, no OkHttp dep (scope.md).
