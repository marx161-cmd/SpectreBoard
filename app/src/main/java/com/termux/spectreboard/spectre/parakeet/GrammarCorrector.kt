// Ported from Outspoke (github.com/minburg/outspoke, GPLv3) inference/GrammarCorrector.kt.
 ...
 * ```
 * and wire `LanguageToolCorrector()` into [com.termux.spectreboard.spectre.parakeet.InferenceService]
