// Ported from Outspoke (github.com/minburg/outspoke, GPLv3) audio/RMSVadFilter.kt.
...
class RMSVadFilter(sensitivity: Float = 0.5f) : VadFilter {
    ...
    companion object {
         ...
         * confirmed. 2 frames x 30 ms = 60 ms - suppresses single-frame plosive pops
         ...
         * 15 frames x 30 ms = 450 ms - captures the first consonant/phoneme of the
         ...
         * 15 frames x 30 ms = 450 ms - captures trailing soft syllables and brief pauses.
         */
        private const val HANGOVER_FRAMES = 15

        /**
         * Frames of continuous SILENCE (after hangover) before emitting a silence-boundary
         * sentinel. 20 frames x 30 ms = 600 ms. Triggers an utterance boundary reset in
