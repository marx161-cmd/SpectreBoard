package com.termux.spectreboard.keyboard.internal
...
import com.termux.spectreboard.latin.settings.customIconIds
...
//            NAME_SPACE_KEY to                   null,
            ...
            ToolbarKey.entries.forEach {
                put(it.name.lowercase(Locale.US), when (it) {
                    ...
                    ToolbarKey.WHISPER_MIC -> R.drawable.sym_keyboard_voice_lxx
                })
            }
        } }
...
//            NAME_SPACE_KEY to                   null,
            ...
            ToolbarKey.entries.forEach {
                put(it.name.lowercase(Locale.US), when (it) {
                    ...
                    ToolbarKey.WHISPER_MIC -> R.drawable.sym_keyboard_voice_rounded
                })
            }
        } }
