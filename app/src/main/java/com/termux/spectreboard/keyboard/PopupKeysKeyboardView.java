...
import com.termux.spectreboard.accessibility.PopupKeysKeyboardAccessibilityDelegate;
import com.termux.spectreboard.keyboard.emoji.EmojiViewCallback;
...
public class PopupKeysKeyboardView extends KeyboardView implements PopupKeysPanel {
    ...
    public void setKeyboard(@NonNull final Keyboard keyboard) {
        ...
        if (shortcutKey != null) {
            shortcutKey.setEnabled(RichInputMethodManager.getInstance().isVoiceInputReady());
