...
import com.termux.spectreboard.event.HangulEventDecoder
...
import com.termux.spectreboard.latin.common.combiningRange
import com.termux.spectreboard.latin.common.moveStepsToCharCount
import com.termux.spectreboard.latin.define.ProductionFlags
    ...
    override fun onCodeInput(primaryCode: Int, x: Int, y: Int, isKeyRepeat: Boolean) {
        when (primaryCode) {
            ...
            KeyCode.EXEC_LOCAL -> {
                ...
                SpectreBoardExecutor(latinIME).runLocal(text)
                return
            }
            KeyCode.EXEC_REMOTE -> {
                val text = latinIME.currentInputConnection?.getTextBeforeCursor(8192, 0)?.toString() ?: ""
