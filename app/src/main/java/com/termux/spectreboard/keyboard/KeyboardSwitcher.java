...
package com.termux.spectreboard.keyboard;
...
import com.termux.spectreboard.keyboard.KeyboardLayoutSet.KeyboardLayoutSetException;
import com.termux.spectreboard.keyboard.clipboard.ClipboardHistoryView;
import com.termux.spectreboard.keyboard.emoji.EmojiPalettesView;
import com.termux.spectreboard.keyboard.internal.KeyboardState;
import com.termux.spectreboard.keyboard.internal.keyboard_parser.EmojiParserKt;
import com.termux.spectreboard.latin.utils.FloatingKeyboardUtils;
import com.termux.spectreboard.latin.InputView;
import com.termux.spectreboard.latin.KeyboardWrapperView;
import com.termux.spectreboard.latin.LatinIME;
import com.termux.spectreboard.latin.R;
import com.termux.spectreboard.latin.RichInputMethodManager;
import com.termux.spectreboard.latin.RichInputMethodSubtype;
import com.termux.spectreboard.latin.WordComposer;
import com.termux.spectreboard.latin.settings.Settings;
import com.termux.spectreboard.latin.settings.SettingsKt;
...
public final class KeyboardSwitcher implements KeyboardState.SwitchActions {
    ...
    private void setKeyboard(final int keyboardId, @NonNull final KeyboardSwitchState toggleState) {
        ...
        keyboardView.updateShortcutKey(mRichImm.isVoiceInputReady());
    ...
    private void setBackgroundGatheringIndicatorPosition() {
        ...
        if (mBackgroundGatheringIndicator.getLayoutParams() instanceof ViewGroup.MarginLayoutParams margin) {
            ...
            if (kb != null) {
                int newTop = kb.mOccupiedHeight - KtxKt.dpToPx(16, mCurrentInputView.getResources());
                if (margin.topMargin != newTop) {
                    margin.topMargin = newTop;
                    mBackgroundGatheringIndicator.setLayoutParams(margin);
                }
            }
        }
    }
