...
import com.termux.spectreboard.latin.DictionaryFacilitatorImpl
...
class ShadowInputMethodManager2 : ShadowInputMethodManager() {
    ...
    override fun getInputMethodList() = listOf(
        if (BuildConfig.BUILD_TYPE == "debug" || BuildConfig.BUILD_TYPE == "debugNoMinify")
            InputMethodInfo("com.termux.spectreboard.debug", "LatinIME", "HeliBoard debug", null)
        else InputMethodInfo("com.termux.spectreboard", "LatinIME", "HeliBoard", null),
    )
    @Implementation
